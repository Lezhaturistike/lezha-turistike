...
export const destinacion=defineType({name:'destinacion',title:'Destinacione',type:'document',fields:[
 ...
 defineField({name:'foto',title:'Foto kryesore',type:'image',options:{hotspot:true}}),defineField({name:'galeria',title:'Galeria',type:'array',of:[{type:'image',options:{hotspot:true}}]}),
 defineField({name:'burimi',title:'Linku i burimit',type:'url'}),defineField({name:'harta',title:'Linku i hartës',type:'url'}),
