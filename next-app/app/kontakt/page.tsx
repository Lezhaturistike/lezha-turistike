      ...
      <main id="home">
        <section className="contact-hero section">
          <div className="contact-intro">
            ...
            <p>Ke pyetje rreth destinacioneve, trashëgimisë kulturore, Web GIS apo projektit? Na shkruaj dhe lidhu me Lezha Turistike.</p>
            <div className="contact-details">
              ...
              <div><span>VENDNDODHJA</span><p>Lezhë, Shqipëri</p></div>
            </div>
            <div className="contact-quick-actions">
              <a className="button dark" href="mailto:lezhaturistike@gmail.com">Na shkruaj <span className="arrow-icon" aria-hidden="true">↗</span></a>
              <a className="contact-map-link" href="https://www.google.com/maps/search/?api=1&query=Lezhe%2C%20Albania" target="_blank" rel="noopener noreferrer">Shiko në hartë <span className="arrow-icon" aria-hidden="true">↗</span></a>
            </div>
          </div>
        ...
        <section className="contact-explore section">
          <div><span className="overline">VAZHDO EKSPLORIMIN</span><h2>Zbulo më shumë nga Lezha.</h2></div>
          <nav aria-label="Eksploro Lezhën">
            <Link href="/destinacione"><span>01</span> Destinacione <span className="arrow-icon" aria-hidden="true">↗</span></Link>
            <Link href="/webgis"><span>02</span> Web GIS <span className="arrow-icon" aria-hidden="true">↗</span></Link>
            <Link href="/galeri"><span>03</span> Galeri <span className="arrow-icon" aria-hidden="true">↗</span></Link>
          </nav>
        </section>
      </main>
      <BackToTop />
