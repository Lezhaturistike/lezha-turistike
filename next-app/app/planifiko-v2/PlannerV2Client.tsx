...
export default function PlannerV2Client({cmsPlaces=[],locale='sq'}:{cmsPlaces:PlannerPlace[];locale?:'sq'|'en'}){
 ...
 const printMap=()=>{if(!stops.length||typeof window==='undefined')return;setMobileFloat(null);setSearchOpen(false);document.body.classList.add('plannerV2Printing');setTimeout(()=>{window.print();setTimeout(()=>document.body.classList.remove('plannerV2Printing'),350)},450)};
