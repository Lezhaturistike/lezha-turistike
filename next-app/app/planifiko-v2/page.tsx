...
import PlannerV2Client,{type PlannerPlace,type PlannerTheme} from "./PlannerV2Client";
...
"duration":coalesce(kohezgjatja,"1 orë"),"preferredTime":coalesce(momentiRekomanduar,"anytime"),"preferredTimeNote":oraRekomanduar,plannerFeatured,"thematicTours":coalesce(plannerThematicTours,[]),"tags":array::compact(coalesce(plannerTags,[])+coalesce(searchKeywords,[])+[zona,adresa])}`;
