...
export default async function DestinationsPage(){
 const destinacionet=await client.fetch(`*[_type=="destinacion"]|order(_createdAt asc){_id,titulli,titulliEn,kategoria,pershkrimi,pershkrimiEn,permbledhje,permbledhjeEn,cfareSheh,cfareShehEn,keshilleVizite,keshilleViziteEn,kohezgjatja,kohezgjatjaEn,oraRekomanduar,oraRekomanduarEn,burimiTitull,"fotoUrl":foto.asset->url,"galeriaUrls":galeria[].asset->url,burimi,harta}`);
